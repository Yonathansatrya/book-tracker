...
<div class="container mx-auto px-4">
    ...
    <a href="{{ route('book-trackers.create') }}" class="bg-amber-700 text-white px-4 py-2 rounded mb-4 inline-block">+ Track Buku</a>
        ...
        @foreach ($trackers as $tracker)
            <div class="border p-4 items-center justify-center rounded-lg shadow-lg">
                ...
                <div class="flex gap-2 mt-2">
                    ...
                    <form action="{{ route('book-trackers.destroy', $tracker) }}" method="POST" onsubmit="return confirm('Yakin hapus tracking ini?')">
                        @csrf
                        @method('DELETE')
