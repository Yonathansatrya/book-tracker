...
@section('content')
    <div class="max-w-4xl mx-auto mt-10 p-6 bg-white border border-gray-200 rounded-[4px] shadow-lg">
        ...
        <form action="{{ route('book-trackers.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <select name="book_id" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-[4px] shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div class="mb-4">
                ...
                <select name="status" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-[4px] shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="last_read_page"
                    ...
                    class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-[4px] shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
            </div>

            <div class="mb-4">
                <label class="block mb-1 font-semibold">Rating (1-5)</label>
                <input type="number" name="rating" min="1" max="5"
                    value="{{ old('rating', $tracker->rating ?? '') }}" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-[4px] shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
            </div>
