    ...
    <div class="container mx-auto px-4">
        ...
        <form action="{{ route('book-trackers.update', $tracker) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <select name="book_id" class="w-full border rounded-[4px] px-3 py-2">
            ...
            <div class="mb-4">
                ...
                <select name="status" class="w-full border rounded-[4px] px-3 py-2">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="last_read_page" value="{{ old('last_read_page', $tracker->last_read_page ?? 0) }}"
                    class="w-full border rounded-[4px] px-3 py-2">
            </div>

            <div class="mb-4">
                <label class="block mb-1 font-semibold">Rating (1-5)</label>
                <input type="number" name="rating" min="1" max="5"
                    value="{{ old('rating', $tracker->rating ?? '') }}" class="w-full border rounded-[4px] px-3 py-2">
            </div>
