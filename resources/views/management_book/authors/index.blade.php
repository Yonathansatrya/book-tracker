...
<div class="max-w-6xl mx-auto mt-10 p-6 bg-white border border-gray-200 rounded-lg shadow-lg">
    ...
    <div class="mb-4">
        <a href="{{ route('authors.create') }}" class="px-4 py-2 bg-amber-700 text-white rounded-md shadow-md focus:outline-none focus:ring-2 focus:ring-indigo-500">
            Tambah Penulis Baru
        </a>
    </div>
            ...
            <tbody>
                ...
                <tr class="border-t border-gray-200">
                    ...
                    <td class="px-4 py-2 text-sm text-gray-800">
                        <a href="{{ route('authors.edit', $author->id) }}" class="text-indigo-600 hover:text-indigo-800">Edit</a> |
